...
<script src="js/galeria/calama.js" type="text/javascript"></script><!--GALERIA FACEBOOK JS-->
					<div class="contenedor_sede">
						...
						<article class="seccion_indicaciones">
							<div class="lateral_left img_left"
								style="
									background: #000000 url(img/calama/mapa.png);
								...
								"
							><!--MAPA-->
								<a target="_blank" href="https://goo.gl/maps/ZdS9NggkZR82">
									<figure>
										<img src="img/calama/mapa.png"><!--MAPA GOOGLE MAPS-->	
									</figure>
								</a>
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								<div class="indicaciones">
									...
									<span>Lunes a Domingo de 11:00 a 21:00hrs</span>
									<br/>
									<p>Dirección <i class="fa fa-angle-left"></i></p>
									<span>II Region, Calama – Balmaceda 2902, Tottus.</span>
									<br/>
									<p>E-mail <i class="fa fa-angle-left"></i></p>
									<span>e@Rallykarting.cl</span>
									<br/>
									<p>Teléfonos <i class="fa fa-angle-left"></i></p>
									<a href="+56972955896"><span>+56972955896</span></a>
									<br/>
						...
						<article class="seccion_novedades">
							<div class="lateral_left img_left"
								style="
                                	background: #F5DA81 url(http://graph.facebook.com/1669875936625049/picture?width=3000);
                                ...
                                <!--IMAGEN NOTICIA-->
                                <figure>
									<a target="_blank" href="https://www.facebook.com/www.rallykarting.cl/">
                                    <img src="http://graph.facebook.com/1669875936625049/picture?width=3000">
									</a>	
								</figure>
                                <!--FIN IMAGEN NOTICIA-->
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
                                ...
                                <?php
								$tl = new timeline (
    							 '1669875936625049', // username or id
					            ...
					            <!--ENUNCIADO-->
					            <p>' . shorten($tl->nl2br2($tl->escape($item->getContent(),true)), 140) . ' <i class="fa fa-angle-right"></i></p>							
					            <!--FECHA-->				
								...
								<a target="_blank" href="https://www.facebook.com/www.rallykarting.cl/"><span class="btn_social">Visitar fanpage</span></a>
							</div>
						</article>
