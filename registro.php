<?php
    ...
    if($datos['ciudad'] == 'Antofagasta' || $datos['ciudad'] == 'La Serena')
    {
    ...
    if ($datos['ciudad'] == 'Barnechea' || $datos['ciudad'] == 'Calama' || $datos['ciudad'] == 'Viña del Mar' || $datos['ciudad'] == 'Santiago Sur' || $datos['ciudad'] == 'Concepción' || $datos['ciudad'] == 'Pto. Montt'){
